...
%\subsection{Variable Selection with Bootstrapping}
%\label{ch:var_sel_boot}
%
%\section{Case Studies with Bootstrap Resampling}
%\label{ch:case_boot_resamp}
%
%\subsection{Simulated Examples}
%\label{ch:cbr_sim_ex}
%
%\subsection{UCI Machine Learning Repository Datasets}
%\label{ch:cbr_UCI_MLR_data}
%
%\section{Using A Horseshoe Prior with a General Covariance Structure}
%\label{ch:hp_gencov}
%
%
%\section{Using A Lasso type prior}
%
%\subsection{Simulated Examples}R
%\label{ch:csa_sim_ex}
%
%\subsection{UCI Machine Learning Repository Datasets}
%\label{ch:csa_UCI_MLR_data}
